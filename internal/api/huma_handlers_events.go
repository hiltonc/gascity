...
// discover that — on high-gas-city a 160 MB events.jsonl, json.Unmarshal'd line
// by line — and the handler then pays a second full pass in the fallback. The
// budget caps that wasted leg. It cannot change any answer: a probe short of
// limit+1 rows was already going to fall through, whatever stopped it.
//
